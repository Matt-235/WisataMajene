        ...
        <div class="col-lg-10">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Tambah Wisata Baru</h4>
                </div>
                <div class="card-body p-5">
                    <form method="POST" action="{{ route('pengelola.wisata.store') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('kapasitas_harian', 100) }}" 
                                           min="1" 
                                           required>
